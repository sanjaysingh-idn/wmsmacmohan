						...
						<div class="card-body">
							...
							<div class="text-center">
								...
								<div class="fs-4 my-3 text-center">
									...
									<br><span class="text-warning fw-bold">Mac Mohan Solo</span>
								</div>
							</div>
							<!-- /Logo -->
							...
							<form id="formAuthentication" class="mb-3" action="{{ route('login') }}" method="POST">
								...
								<div class="mb-3">
									<button class="btn btn-warning w-100" type="submit"><i class='bx bx-log-in'></i> Login</button>
								</div>
							</form>
							<div class="row">
								<div class="col-12">
									<small>Tidak punya akun? Silahkan melakukan pengajuan pembuatan akun <strong><a
												href="/pengajuan-akun">Disini</a></strong></small>
								</div>
							</div>
						</div>
					</div>
