	...
	<div class="row mb-3">
		<div class="col-6">
			<h2 class="fw-bold">
				...
				Laporan Packing List / Barang Keluar
			</h2>
			<div class="card">
				<div class="card-header">
					<div class="text-start">
						Formulir cetak Laporan Kain Keluar
						<hr>
					</div>
				</div>
				<div class="card-body">
					...
					<form action="{{ route('laporanPackingList.generate-report-packingList') }}" method="post" id="reportForm">
						@csrf
						<div class="row">
